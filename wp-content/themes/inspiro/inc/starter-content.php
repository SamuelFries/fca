		...
		'posts'       => array(
			'front' => array(
				...
				'post_content' => '
                    ...
                    <p class="has-text-align-center has-white-color has-text-color has-max-60-font-size" style="font-style:normal;font-weight:900;line-height:1.2"><strong>Fries & Cabral</strong></p>
                    <!-- /wp:paragraph -->

                    <!-- wp:paragraph {"align":"center","textColor":"white","fontSize":"medium"} -->
                    <p class="has-text-align-center has-white-color has-text-color has-medium-font-size">Advogados Associados</p>
                    <!-- /wp:paragraph -->
                    ...
                    <div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-white-color has-text-color wp-element-button" href="#" style="border-radius:0px">Saiba Mais</a></div>
                    <!-- /wp:button --></div>
                    <!-- /wp:buttons --></div></div>
                    <!-- /wp:cover -->
                    ...
                    <h2 class="wp-block-heading has-text-align-center has-medium-font-size" style="letter-spacing:1px">NÓS SOMOS REFÊNCIA NO DIREITO DO TRABALHO</h2>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"align":"center"} -->
                    <p class="has-text-align-center">
Atuamos na defesa do direito dos trabalhadores de todos os seguimentos e categorias, em especial, os bancários, petroleiros, caminhoneiros, metalúrgicos, bem como aqueles atuantes nas indústrias petroquímicas do polo petroquímico de Triunfo-RS, Capuava-SP, Paulínia-SP, Duque de Caxias-RJ e Camaçari-BA, dentre outros.</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center","orientation":"horizontal"}} -->
                    <div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"0px"}},"className":"is-style-outline","fontSize":"small"} -->
                    <div class="wp-block-button has-custom-font-size is-style-outline has-small-font-size"><a class="wp-block-button__link wp-element-button" href="#" style="border-radius:0px">SOBRE NÓS</a></div>
                    <!-- /wp:button --></div>
                    <!-- /wp:buttons -->
                    ...
                    <p class="has-text-align-left has-secondary-color has-text-color" style="letter-spacing:1px">O MELHOR PARA VOCÊ!</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:heading {"textAlign":"left"} -->
                    <h2 class="wp-block-heading has-text-align-left">Nossos serviços</h2>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"align":"left"} -->
                    <p class="has-text-align-left">
Os Advogados da FRIES & CABRAL, estão sempre prontos a ouvir seus clientes, identificar e indicar o melhor caminho para solução dos eventuais conflitos.</p>
                    <!-- /wp:paragraph -->
...
<!-- /wp:columns -->
                    ...
                    <p class="has-secondary-color has-text-color has-link-color">Conheça-nos</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:heading -->
                    <h2 class="wp-block-heading">O Time</h2>
                    <!-- /wp:heading -->
                    ...
                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">Pedro Fernando Fries</h3>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|tertiary"}}}},"textColor":"tertiary"} -->
                    <p class="has-tertiary-color has-text-color has-link-color">OAB/RS 60.703O</p>
                    <!-- /wp:paragraph -->
                    ...
                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">André Nascimento Cabral</h3>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|tertiary"}}}},"textColor":"tertiary"} -->
                    <p class="has-tertiary-color has-text-color has-link-color">OAB/RS 46.793</p>
                    <!-- /wp:paragraph -->
                    ...
                    <!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
                    <div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"0px"}},"className":"is-style-outline"} -->
                    <div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="#" style="border-radius:0px">SAIBA MAIS</a></div>
                    <!-- /wp:button --></div>
                    <!-- /wp:buttons -->
